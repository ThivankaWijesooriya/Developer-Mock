...
<div id="page-wrapper">
	...
	<div class="container-fluid">
		...
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Create IOU</h1>
				...
				<div class="panel panel-warning">
					...
					<div class="panel-body">
						...
						<form:form action="${pageContext.request.contextPath}/IOU/Create/Submit"
								...
								<div class="form-group">
									...
									<div class="row">
										...
										<div class="col-sm-6">
											...
											<form:textarea class="form-control" rows="4" placeholder="" path="description" maxlength="80"/>
                               	...
                               	<div class="form-group">
									...
									<div class="row">
										<label class="col-sm-2" for="exampleInputEmail1">Date <span class="required">&nbsp *</span></label>
										<div class="col-sm-6">
										
											<form:input class="form-control" placeholder="" path="ioudate" id="cdate" type="date" readonly="true"/>
						...
						<div class="form-group d-none" id="fromfield">
									...
									<div class="row">
										<label class="col-sm-2" for="exampleInputEmail1">From <span class="required">&nbsp *</span></label>
										<div class="col-sm-6">
										
											<form:input class="form-control" placeholder="" path="fromlocation"  type="" maxlength="30"/>
							...
							<div class="form-group d-none" id="tofield">
									...
									<div class="row">
										<label class="col-sm-2" for="exampleInputEmail1">To <span class="required">&nbsp *</span></label>
										<div class="col-sm-6">
										
											<form:input class="form-control" placeholder="" path="tolocation"  type="" maxlength="30"/>
							...
							<div class="form-group d-none" id="viafield">
									...
									<div class="row">
										...
										<div class="col-sm-6">
											...
											<form:input class="form-control" placeholder="" path="via"  type="" maxlength="30"/>
							...
							<div class="row">
								...
								<div class="col-sm-6">
									...
									>Submit</button>
									 &nbsp &nbsp
									<div class="btn btn-sm btn-warning" id="clearBTN">Clear</div>
