	...
	<div id="wrapper">
		...
		<div id="page-wrapper">
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-lg-12">
						<h1 class="page-header">Create Voucher</h1>
				      ...
				      <div class="space-20"></div>
						...
						<div class="panel panel-warning">
							...
							<div class="panel-body">
								...
								<form:form
									action="${pageContext.request.contextPath}/Voucher/Create/Submit"
									method="POST" modelAttribute="voucher" id="createform">
									...
									<div class="col-md-8">
										...
										<div class="form-group">
											...
											<div class="row">
												<label class="col-sm-2" for="exampleInputEmail1">Date<span class="required">&nbsp; *</span></label>
												<div class="col-sm-6">
										...
										<div class="form-group">
											...
											<div class="row">
												...
												<label class="col-sm-2" for="exampleInputEmail1">Is
										...
										<div class="form-group d-none" id="ioucolumn">
											...
											<div class="row">
												<label class="col-sm-2" for="exampleInputEmail1">Settled
										...
										<div class="form-group">
											...
											<div class="row">
												...
												<div class="col-sm-6">
													<form:input class="form-control" placeholder=""
														path="amount" id="Amount" maxlength="13" />
									...
									<div class="row">
										...
										<div class="col-sm-6">
											<button type="submit" id="addbtn" class="btn btn-sm btn-success">Submit</button>
											&nbsp &nbsp
