...
<div id="page-wrapper">
	...
	<div class="container-fluid">
		...
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Authorized IOU Return </h1>
					
					
				<button type="button" class="btn btn-primary" id="inquire">Return </button>	
				...
				<div class="panel-body">
		         ...
		         <form id="returnform" action="${pageContext.request.contextPath}/IOU_Return/Inquiry/ViewIouReturn" method="GET">
