	...
	<div id="wrapper">
		...
		<div id="page-wrapper">
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-lg-12">
						<h1 class="page-header">Approve Voucher</h1>
							...
							<div class="panel-body">
								...
								<form:form action="" method="POST" modelAttribute="voucher"
											...
											<div class="row">
												...
												<div class="col-sm-6">
													...
													<textarea rows="4" class="form-control" maxlength="250"
														name="comments" id="comments" value="">${AppComments}</textarea>
									...
									<div class="row">
										...
										<div class="col-sm-6">
											<!-- <div id="approveBTN" class="btn btn-sm btn-primary">Approve</div>
											&nbsp &nbsp -->
											...
											<c:choose>
												  ...
												  <c:when test="${AuthReject}">
												    ...
												    <button id="approveBTN" class="btn btn-sm btn-primary" disabled>Approve</button>
											         &nbsp &nbsp
							...
							$('#accept')
									.click(
											function() {
												...
												$('#formId')
														.attr('action',
																'${pageContext.request.contextPath}/Voucher/Approve/Submit')
														.submit();
