						...
						<form:form action="${pageContext.request.contextPath}/PettyCashFloat/Create/Submit"
							...
							<div class="col-md-8">
								...
								<div class="form-group">
									...
									<div class="row">
										<label class="col-sm-2" for="exampleInputEmail1">Cheque No.<span class="required">&nbsp *</span>
										</label>
										<div class="col-sm-6">
	
											
                                             <form:input class="form-control" placeholder="" autocomplete="off" path="chequeno" maxlength="50"/>
								...
								<div class="form-group">
									...
									<div class="row">
										...
										<div class="col-sm-6">
											...
											<form:input class="form-control" placeholder="" path="reorderamount" id="Amount2" maxlength="13" />
	...
	$("#Amount2").on("input", function(evt) {
		   ...
		   self.val(self.val().replace(/[^0-9\.]/g, ''));
		    ...
		    if (number[1].length > 2)
		    {
		    	...
		    	var num = parseFloat($("#Amount2").val());
		        $("#Amount2").val( num.toFixed(2)); 
