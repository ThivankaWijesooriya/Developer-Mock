			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-lg-12">
						...
						<form id="viewform" action="${pageContext.request.contextPath}/UserManagement/view" method="GET" >
 			...
 			$.each(obj, function(key, value) {
				...
				strVar5 += "<img src=\"data:image\/jpeg;base64,"+value.Imgbase64+"\" class=\"empimg\">";
				 ...
				 $('#tblemp').DataTable().row.add(
							[strVar5,value.userid,value.empfullname,value.department.deptname,value.designation.designame,value.temprptoff1,strVar3 ])
							.draw(); 
