...
<div id="page-wrapper">
	...
	<div class="container-fluid">
		...
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Create IOU Return</h1>
						 ...
						 method="POST"  modelAttribute="IOU">
							...
							<div class="col-md-8">
								...
								<div class="form-group">
									...
									<div class="row">
										<label class="col-sm-2" for="exampleInputEmail1">IOU No.
										<span class="required">&nbsp *</span> </label>
										<div class="col-sm-6">
	
										<form:select path="iouno" class="form-control" id="iounum">
								...
								<div class="form-group">
									...
									<div class="row">
										<label class="col-sm-2" for="exampleInputEmail1">Amount</label>
										<div class="col-sm-6">
                               	...
                               	<div class="form-group">
									...
									<div class="row">
										<label class="col-sm-2" for="exampleInputEmail1">Is Iou Return <span class="required">&nbsp *</span></label>
										<div class="col-sm-6">
										
											<form:checkbox path="IsIouReturn" />
						   ...
						   <div class="form-group" >
									...
									<div class="row">
										<label class="col-sm-2" for="exampleInputEmail1">Reason <span class="required">&nbsp *</span></label>
										<div class="col-sm-6">
										
											<form:textarea class="form-control" path="returnComments" cols="4" rows="3"/>
