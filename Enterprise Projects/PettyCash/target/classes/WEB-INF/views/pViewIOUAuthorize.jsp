...
<div id="page-wrapper">
	...
	<div class="container-fluid">
		...
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Authorize IOU </h1>
						...
						<form:form action=""
						 ...
						 <div class="form-group d-none" id="fromfield">
							...
							<div class="form-group">
                                 	...
                                 	<div class="row">
										...
										<div class="col-sm-6">
											...
											<textarea rows="4" class="form-control" maxlength="250" name="comments" id="comments" value=""> ${AuthComments}</textarea>
							...
							<div class="row">
								...
								<div class="col-sm-6">
									<!-- <div id="authorizeBTN" class="btn btn-sm btn-primary"
									>Authorize</div>
									 &nbsp &nbsp -->
									...
									<c:choose>
									 ...
									 <c:choose>
										...
										<c:when test="${AuthReject}">
												...
												<button id="authorizeBTN" class="btn btn-sm btn-primary"
...
$(document).ready(function() {
	...
	$('#accept').click(function(){
		...
		$('#formId').attr('action', '${pageContext.request.contextPath}/IOU/Authorize/Submit').submit();
