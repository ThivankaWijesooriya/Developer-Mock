...
<div id="page-wrapper">
	...
	<div class="container-fluid">
		...
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Authorize IOU Return</h1>
				...
				<div class="panel panel-warning">
					...
					<div class="panel-body">
						...
						<form:form action=""
						 method="POST"  modelAttribute="IOU" id="ioureturnform">
                               	...
                               	<div class="form-group">
									...
									<div class="row">
										...
										<div class="col-sm-6">
											...
											<form:checkbox path="IsIouReturn" readonly = "true" />
								...
								<div class="col-sm-6">
									...
									<c:choose>
									   ...
									   <c:choose>
										...
										<div id="saveBTN" class="btn btn-sm btn-primary" >Authorize</div>
...
$(document).ready(function() {
	...
	$("#iounum").change(function(){
	 ...
	 $("#return").click(function(){
		 ...
		 window.location.href = "${pageContext.request.contextPath}/Request/Authorize/GET";
	...
	$('#ioureturnform').attr('action', '${pageContext.request.contextPath}/IOU_Return/ViewIouReturn/Authorize/Submit').submit();
	...
	$('#ioureturnform').attr('action', '${pageContext.request.contextPath}/IOU_Return/ViewIouReturn/Reject/Submit').submit();
