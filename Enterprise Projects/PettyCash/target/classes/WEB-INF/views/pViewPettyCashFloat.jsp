			...
			<div class="col-lg-12">
				...
				<div class="panel panel-warning">
					...
					<div class="panel-body">
						...
						<form:form action="${pageContext.request.contextPath}/PettyCashFloat/Create/Submit"
								...
								<div class="form-group">
									...
									<div class="row">
										...
										<div class="col-sm-6">
											...
											<form:input class="form-control" placeholder="" path="amount" id="Amount" readonly="true" maxlength="13" />
								...
								<div class="form-group">
									...
									<div class="row">
										...
										<div class="col-sm-6">
											...
											<form:input class="form-control" placeholder="" path="reorderamount" readonly="true" maxlength="13" />
                               	...
                               	<div class="form-group">
									...
									<div class="row">
										<label class="col-sm-2" for="exampleInputEmail1">Cheque Date <span class="required">&nbsp *</span> </label>
										<div class="col-sm-6">
										
											<form:input class="form-control" placeholder="" path="date" readonly="true" type="date"/>
						   ...
						   <div class="form-group" id="fromfield">
									...
									<div class="row">
										<label class="col-sm-2" for="exampleInputEmail1"></label>
										<div class="col-sm-6">
										
											
											<input type="button" value="View Document" id="opendoc"/>
