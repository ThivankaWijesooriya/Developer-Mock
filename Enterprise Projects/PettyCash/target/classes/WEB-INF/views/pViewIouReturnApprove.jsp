...
<div id="page-wrapper">
	...
	<div class="container-fluid">
		...
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Approve IOU Return</h1>
				...
				<div class="panel panel-warning">
					...
					<div class="panel-body">
						...
						<form:form action="" method="POST"  modelAttribute="IOU" id="ioureturnAppform">
						   ...
						   <div class="form-group" >
						    ...
						    <div class="row">
								...
								<div class="col-sm-6">
								    ...
								    <button id="saveBTN" class="btn btn-sm btn-primary" >Approve</button>
												
									&nbsp; &nbsp;
									
									<button id="rejectBTN" class="btn btn-sm btn-danger" >Reject</button>
...
$(document).ready(function() {
	...
	$("#iounum").change(function(){
	 ...
	 $('#saveBTN').click(function(){
			...
			$('#ioureturnAppform').attr('action', '${pageContext.request.contextPath}/IOU_Return/ViewIouReturn/Approve/Submit').submit();
	 ...
	 $('#rejectBTN').click(function(){
			...
			$('#ioureturnAppform').attr('action', '${pageContext.request.contextPath}/IOU_Return/ViewIouReturn/Reject/Approver/Submit').submit();
