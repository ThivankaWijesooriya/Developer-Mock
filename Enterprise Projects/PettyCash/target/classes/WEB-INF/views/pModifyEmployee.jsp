						...
						<div class="panel panel-warning">
							...
							<div class="panel-body">
								...
								<form:form id="employeeform"
									action="${pageContext.request.contextPath}/Employee/Update/Submit?${_csrf.parameterName}=${_csrf.token}"
									...
									<div class="col-md-6">
                                     ...
                                     <div class="form-group">
											<div class="row">
											<label class="col-sm-3" for="exampleInputEmail1">Employee No.</label>
												
												<div class="col-sm-7">
													<input class="form-control" placeholder=""
														 type="text" id="empidno" name="empidno" value="" readonly="true"/>
										...
										<div class="form-group">
											<div class="row">
												...
												<div class="col-sm-7">
													<form:input class="form-control" placeholder=""
														path="empfirstname" maxlength="30"/>
										...
										<div class="form-group">
											<div class="row">
												...
												<div class="col-sm-7">
													<form:input class="form-control" placeholder=""
														path="empfullname" maxlength="100"/>
										...
										<div class="form-group">
											<div class="row">
												<label class="col-sm-3" for="exampleInputEmail1">Email<span class="required">&nbsp *</span></label>
												<div class="col-sm-7">
													<form:input class="form-control" placeholder=""
											...
											<div class="row">
												<div class="d-none" id="hideflag">
													<label class="col-sm-3" for="exampleInputEmail1">Date
														of Resignation <span class="required">&nbsp; *</span></label>
													<div class="col-sm-7">
										...
										<div class="form-group">
											<div class="row">
												<div class="d-none" id="hideflag2">
													<label class="col-sm-3" for="exampleInputEmail1">Date
														of Termination <span class="required">&nbsp; *</span></label>
													<div class="col-sm-7">
                                      ...
                                      <div class="form-group">
										...
										<div class="form-group">
											<div class="row">
												...
												<div class="col-sm-7">
													<form:input class="form-control" placeholder=""
														path="Username" maxlength="30" readonly="true"/>
									...
									<div class="col-md-6">
										...
										<div class="row">
											...
											<div class="col-sm-2">
												<button type="button" id="clearbtn" class="btn btn-sm btn-warning">Return</button>
											</div>
	...
	<script>
		 ...
		 $(document).ready(function() {
			 ...
			 $("#temprptoff1").keyup(function(){
	             	...
	             	var temprptoff1 =  $('#temprptoff1').val();
			 ...
			 $("#temprptoff2").keyup(function(){
	             	...
	             	var temprptoff2 =  $('#temprptoff2').val();
