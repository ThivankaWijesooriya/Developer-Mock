...
<div id="page-wrapper">
	...
	<div class="container-fluid">
		...
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Delete IOU </h1>
				...
				<div class="panel panel-warning">
					...
					<div class="panel-body">
						...
						<form:form action="${pageContext.request.contextPath}/IOU/Delete/Submit"
						...
						<div class="form-group d-none" id="fromfield">
									...
									<div class="row">
										<label class="col-sm-2" for="exampleInputEmail1">From</label>
										<div class="col-sm-6">
							...
							<div class="form-group d-none" id="tofield">
									...
									<div class="row">
										<label class="col-sm-2" for="exampleInputEmail1">To</label>
										<div class="col-sm-6">
